<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="报告生成时间" sortable="custom" width="120px">
        <template slot-scope="{row}">
          <span>{{ row.timestamp | parseTime('{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" label="报告类型" width="110px">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="Date" prop="timestamp">
          <el-date-picker v-model="temp.timestamp" placeholder="Please pick a date" type="datetime" />
        </el-form-item>
